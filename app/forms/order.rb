class Order
  ...
  with_options presence: true do
    validates :municipality, :house_number, :building_name, :token, :item_id, :user_id
  ...
  def save
    ...
    @adress = Adress.create(postal_number: postal_number, birthplace_id: birthplace_id, municipality: municipality, house_number: house_number, building_name: building_name, phone_number: phone_number, item_id: item_id)
